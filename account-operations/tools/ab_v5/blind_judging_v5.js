...
// 它们由 make_judge_prompts_v5.py 在跑之前从单一模板生成、当场核验逐字同构、落盘冻结；
...
// 所以"判定者拿到的就是 make_judge_prompts_v5.py 冻结的那 36 份"是可核对的事实，
// 而不是本文件的一句承诺。unblind_v5.py 的 T-3 会把这 36 个文件逐份哈希比对。
const jobs = []
