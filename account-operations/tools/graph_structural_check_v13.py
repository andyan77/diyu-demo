#!/usr/bin/env python3
"""EP-05 structural check（第 7 轮，对 v1.3 已发布图重跑） on the live M3 Dify candidate graph.
...
OUT = "/home/faye/diyu-demo-worktrees/m3-account-content-operator-v1/account-operations/evidence/ep21-structural-v13"
