...
必须先于结果存在，所以它连同 make_judge_prompts_v4.py 一起在跑之前提交。
...
REL_SELF = "account-operations/tools/ab_v4/unblind_v4.py"
...
HOMO = os.path.join(OUT_OF_REPO, "_prompt_homomorphism_v4.json")
SEALED = ("/tmp/claude-1000/-home-faye-diyu-demo/"
          "2c670698-40ad-483e-b793-56ac12fb6aea/scratchpad/m3/ab/_SEALED_AB_MAPPING_v4.json")
EVID = os.path.join(WT, "account-operations/evidence/ep08-module-ab-v13")
...
def main():
    ...
    with open(os.path.join(EVID, "_unblinded_results_v4.json"), "w", encoding="utf-8") as f:
