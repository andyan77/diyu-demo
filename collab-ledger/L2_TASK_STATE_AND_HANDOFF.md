...
|---|---|---|---|
| `COLLAB-LEDGER-BOOTSTRAP-001` | **见 §一.1** | [L1 §T-001](L1_TASK_MANIFESTS.md) · [L3 §ATT-001](L3_ATTEMPTS_AND_EVIDENCE.md) | `6ae78ab` |
...
**当前活动 `task_id` 只有 1 个，所以本表只有 1 行**——这是**当前事实**，不是「全局唯一下一步」的设计。新任务被授权时**新增一行**，**不覆盖**已有行。
