...
| `DIYU-V1-M2-BUSINESS-PERSISTENCE-VERSION-FEEDBACK-001` | [M2 施工 Execution Prompt v1.1](../decision-chain/docs/M2_ENGINEERING_EXECUTION_PROMPT_v1.1.md) | 本任务自身 Task Contract（内嵌于该 Prompt §3，独立复算 `task_contract_hash = 4d14eb35c065b650b0380b0c309e0e08ec32e3aa608ece4d62e8d27b97450830`，见 [L1 §T-010](L1_TASK_MANIFESTS.md)） | 工程实现 M2 全部 P0（业务持久化边界、任务快照投影、版本晋升、发布/反馈身份、迁移、Dify 候选运行、独立审查、远程任务分支收口） | 独立 worktree／任务分支 `task/m2-business-persistence-version-feedback-v1`；开工前须先完成该 Prompt §4 入口门（read-only 核验 PostgreSQL/Dify、编译 Run Manifest） | `main @ 3fcfac02365b398593634f0449921f4775f06af4` ＋ 该 Prompt 全文 | `M2-AC-00` 至 `M2-AC-17` 全部 PASS ＋ 提交 Founder Dify 实测包，见该 Prompt §9/§12 |
