...
|---|---|---|---|
| `COLLAB-LEDGER-BOOTSTRAP-001` | **非终态 —— 执行中**（见 §一.1） | [L1 §T-001](L1_TASK_MANIFESTS.md) · [L3 §ATT-004](L3_ATTEMPTS_AND_EVIDENCE.md)（**当前** attempt；ATT-001／002／003 为已判不通过的历史轮次） | `6ae78ab` |
