#!/usr/bin/env python3
"""Run exactly one frozen AC-12 authority/delivery scene without manual retry."""
...
def psql(sql: str) -> str:
    result = subprocess.run(
        ["docker", "exec", "-i", "docker-db_postgres-1", "psql", "-U", "postgres", "-d", "dify", "-tA", "-v", "ON_ERROR_STOP=1", "-c", sql],
