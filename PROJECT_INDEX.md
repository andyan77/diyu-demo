...
| [M1–M4 Phase 0 共享编译前言](decision-chain/docs/V1_M1_M4_CONSTRUCTION_PROMPT_SHARED_PREAMBLE_v0.1.md) | `FOUNDER_AUTHORIZED_FOR_VALIDATION_AND_ADOPTION` | 供规划侧编译 M1—M4 各自施工 Execution Prompt 的共同前言；**不构成任何工程实现授权**（`engineering_execution_authorized: false`） |
