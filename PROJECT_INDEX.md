...
| **最小事实夹具（两段链集成测试专用，非真实经营事实）** | 夹具 → [content-production/fixtures/CONTENT_PRODUCTION_MINIMAL_CHAIN_FIXTURE_v0.1.md](content-production/fixtures/CONTENT_PRODUCTION_MINIMAL_CHAIN_FIXTURE_v0.1.md)<br>运行记录 → [content-production/evidence/CONTENT_PRODUCTION_PRE_CHAIN_FIXTURE_RUN_001.md](content-production/evidence/CONTENT_PRODUCTION_PRE_CHAIN_FIXTURE_RUN_001.md) —— **BLOCKED：已证伪「缩小输入可绕过 600 s」，见该文件第 10.2 节** |
