...
def judge():
    ...
    verdicts.append(V("AC-26", "共同质量底线", [
        ...
        C("负向：模板腔 / 无用废话 / 机械复制被拦", "NOT_VERIFIED",
          "**冻结判据只写「负向：模板腔注入探针」，夹具包 v0.1 里没有对应的具名夹具**，"
          "无冻结输入可跑。按 A2，看到结果之后现造一个注入样本不能充当冻结夹具。"
          "登记为 M4-FND-009：判据引用了不存在的夹具，需 Founder 决定补夹具（v0.2）还是修判据。"),
    ], ["FA-34", "FA-36"], "H+S"))
